...
const DisplayData = (props) => (
    ...
    {(props.city && props.ok) &&<div className="DisplayData__info">
     ...
     <p className = "DisplayData__key">Sunrise: <span className = "DisplayData__value">{Date(props.sunrise)}</span></p>
     <p className = "DisplayData__key">Sunset: <span className = "DisplayData__value">{Date(props.sunset)}</span></p>
    </div>
